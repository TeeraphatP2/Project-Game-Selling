        ...
        <form onsubmit="login(event)">
            <div class="flex flex-col items-center text-[19px] w-full">
                <fieldset class="border rounded-lg border-blue-900 w-full">
                    <legend >Email</legend>
                    <input class="text-[16px] box-border focus:outline-none w-full max-w-full pl-2" type="email" name="email" id="email" autocomplete="off" required>
                </fieldset>

                <fieldset class="border rounded-lg border-blue-900 w-full">
                    <legend >รหัสผ่าน</legend>
                    <input class="text-[16px] box-border focus:outline-none w-full max-w-full pl-2" type="password" name="password" id="password" autocomplete="off" required>
                </fieldset>
